...
for (j in 1:n_runs) {
  ...
  data_test_list <- list(sim_uni_smooth(n_test, FALSE), sim_uni_jump(n_test, FALSE), sim_uni_sin(n_test, FALSE),
                         sim_tri_smooth(n_test, FALSE), sim_tri_jump(n_test, FALSE), sim_tri_sin(n_test, FALSE),
                         sim_five_smooth(n_test, FALSE), sim_five_jump(n_test, FALSE), sim_five_sin(n_test, FALSE))
